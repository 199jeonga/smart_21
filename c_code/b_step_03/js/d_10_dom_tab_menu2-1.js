...
// 기능
  // 0. 삽입할 요소
  var innerCode = '<a href="#" data-id><h4 class="event_title">제목</h4><p class="event_narration">설명</p><dl class="date"><dt class="blind">기간</dt><dd날짜</dd></dl><dl >class="event_check success"><dt>이벤트 상황</dt><dd>진행예정</dd></dl></a>';
